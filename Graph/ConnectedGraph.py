...
def bfs_startegy_for_adjacencyMatrix_connectivitycheck(fvAMatrix):
    """" Assiggn each vertex a component number & start BFS/DFS from vertex 0.
...
tvAdjecenyMatrix  = CommonGraph.create_graph_into_adjacency_matrix(4)
...
if(len(tvUniqueComponentNumberList) == 1):
    print("Graph is connected")
else:
    print("Graph is disconnected and there is " + str(len(tvUniqueComponentNumberList)) + " component number(maximum subsets of connected vertex)")
